...
import { ChevronDown, ChevronRight, CircleUserRound, History as HistoryIcon, Infinity as InfinityIcon, MonitorUp, PanelLeftClose, PanelLeftOpen, Plus } from "lucide-react";
    ...
    const groups: WorkspaceNavGroup[] = [
        {
            items: [
                ...
                { id: "tools-upscale", title: "视频超分", icon: MonitorUp, to: "/tools/upscale" },
            ],
        },
        {
            heading: "资源与工具",
